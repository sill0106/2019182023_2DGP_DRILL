...
# 이벤트 정의
# RD, LD, RU, LU = 0, 1, 2, 3
RD, LD, RU, LU, TIMER, SWITCH = range(6) # 타이머 이벤트 추가.
...
next_state = {
    AUTO_RUN: { RU : AUTO_RUN, LU : AUTO_RUN, RD : AUTO_RUN, LD : AUTO_RUN, TIMER : AUTO_RUN, SWITCH : IDLE},
    SLEEP: { RU : RUN, LU : RUN, RD : RUN, LD : RUN, TIMER : SLEEP, SWITCH : AUTO_RUN},
    IDLE : { RU : RUN, LU : RUN, RD : RUN, LD : RUN , TIMER : SLEEP, SWITCH : AUTO_RUN},
    RUN  : { RU : IDLE, LU : IDLE, RD : IDLE, LD : IDLE, TIMER : RUN, SWITCH : AUTO_RUN}
